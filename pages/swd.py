...
with col1:
    ...
    <div class="content">
            ...
            <div class="link-icons">
                ...
                <img src="https://img.icons8.com/?size=100&id=19318&format=png&color=000000" style="width: 20px; height: auto;">
                <span style="font-size: 0.8em;">Demo</span> 
                </a>
                <a href="https://www.linkedin.com/feed/update/urn:li:activity:7237831769532612608/" target="_blank">
                <img src="https://upload.wikimedia.org/wikipedia/commons/c/ca/LinkedIn_logo_initials.png" style="width: 15px; height: auto;">
    ...
    <div class="content">
            ...
            <div style="display: flex; align-items: center;"> 
                  ...
                  <img src="https://www.vectorlogo.zone/logos/mysql/mysql-official.svg" alt="Tool 1" style="width: 40px; height: auto; margin-right: 10px;">
                  <img src="https://www.vectorlogo.zone/logos/docker/docker-icon.svg" alt="Tool 1" style="width: 40px; height: auto; margin-right: 10px;">
                  <img src="https://www.vectorlogo.zone/logos/kubernetes/kubernetes-icon.svg" alt="Tool 1" style="width: 30px; height: auto; margin-right: 10px;">
                  <img src="https://upload.wikimedia.org/wikipedia/commons/d/d5/Selenium_Logo.png" alt="Tool 1" style="width: 25px; height: auto; margin-right: 10px;">
            </div>
    ...
    <div class="content">
            ...
            <div style="display: flex; align-items: center;"> 
                  <h3>Made with:</h3>
                  <img src="https://upload.wikimedia.org/wikipedia/commons/c/c3/Python-logo-notext.svg" alt="Tool 1" style="width: 30px; height: auto; margin-right: 10px; margin-left:-10px;">
                  <img src="https://upload.wikimedia.org/wikipedia/commons/9/93/Amazon_Web_Services_Logo.svg" alt="Tool 1" style="width: 30px; height: auto; margin-right: 10px;">
            </div>
    ...
    <div class="content">
            ...
            <div style="display: flex; align-items: center;"> 
                  <h3>Made with:</h3>
                  <img src="https://upload.wikimedia.org/wikipedia/commons/1/17/Google-flutter-logo.png" alt="Tool 1" style="width: 65px; height: auto; margin-right: 10px; margin-left:-10px;">
                  <img src="https://upload.wikimedia.org/wikipedia/commons/8/8a/Google_Gemini_logo.svg" alt="Tool 1" style="width: 45px; height: auto; margin-right: 10px;">
            </div>
            ...
            <div class="link-icons">
                ...
                <img src="https://upload.wikimedia.org/wikipedia/commons/0/0d/Medium_%28website%29_logo.svg" style="width: 60px; height: auto;">
                <span style="font-size: 0.8em;">Article</span> 
                </a>
            </div>
        </div>
    """,unsafe_allow_html=True)
